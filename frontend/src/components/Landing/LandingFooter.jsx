...
export default function LandingFooter() {
  return (
    <footer className="relative border-t py-12 overflow-hidden" style={{ borderColor: 'rgba(255,255,255,0.04)', background: 'rgba(0,0,0,0.6)' }}>
      {/* Gold accent glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[400px] h-px" style={{ background: 'linear-gradient(90deg, transparent, rgba(200,200,208,0.3), rgba(222,222,228,0.5), rgba(200,200,208,0.3), transparent)' }} />
      <div className="absolute top-[-40px] left-1/2 -translate-x-1/2 w-[300px] h-[80px]" style={{ background: 'radial-gradient(ellipse, rgba(200,200,208,0.04), transparent)', filter: 'blur(20px)' }} />
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="pt-8 border-t flex flex-col md:flex-row items-center justify-between gap-4" style={{ borderColor: 'rgba(255,255,255,0.04)', boxShadow: '0 -1px 0 rgba(200,200,208,0.06)' }}>
